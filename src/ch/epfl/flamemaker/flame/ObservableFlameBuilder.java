...
public class ObservableFlameBuilder {
	...
	/**
	 * Ajoute un observateur au bâtisseur. Les observateurs sont notifiés à
	 * chaque changement du bâtisseur par l'appel de leur méthode
	 * {@link #Listener.onFlameBuilderChange()}
	 * 
	 * @param l
	...
	/**
	 * Supprime un observateur si il a été ajouté précédemment. Celui-ci ne sera
	 * plus notifié des modifications sur le bâtisseur.
	 * 
	 * @param l
	...
	/**
	 * @param index
	 * @return La composante affine de la transformation d'index <i>index</i> de
	 *         la fractale
	...
	/**
	 * Remplace la composante affine de la transformation d'index <i>index</i>
	 * par <i>newTransformation</i>
	 * 
	 * @param index
	...
	/**
	 * Retourne le poids de la variation <i>variation</i> pour la transformation
	 * d'index <i>index</i>
	 * 
	 * @param index
	 *            L'index de la transformation
	...
	/**
	 * Modifie le poids de la variation <i>variation</i> pour la transformation
	 * d'index <i>index</i>
	 * 
	 * @param index
	 *            L'index de la transformation
	...
	public interface Listener {
		...
		/**
		 * Appelée quand un ObservableFlameBuilder que cet objet observe est
		 * modifié.
		 * 
		 * @param b
		 *            bâtisseur modifié (ce paramètre permet à une même instance
		 *            d'observer plusieurs bâtisseurs)
		 */
