...
/**
 * Enumération contenant des préréglages de FlameSet.  
 * 
...
public enum Presets {
	...
	/**
	 * Une liste de quelques fractales prédéfinies, parmi lesquelles
	 * SharkFin, Turbulence, Fougère et une fractale vide.
	 */
	 ...
	 */
	private Presets(String name, Rectangle frame, Palette palette, List<FlameTransformation> transformations){
		m_displayableName = name;
		m_frame = frame;
		m_palette = palette;
	 ...
	 * @return une string contenant le nom du preset.
	 */
	public String displayableName(){		return m_displayableName; 		}
	
	/**
	 * Retourne le cadre associé au preset
	 * @return Rectangle, cadre de l'accumulateur de flame
	 */
	public Rectangle frame(){ 	return m_frame; 	}
	
	/**
	 * Retourne la palette associée au preset
