...
public class FlameTransformation implements Transformation{
	...
	/**
	 * Construit une transformation de type Flame à partir de sa composante affine et des poids des différentes variations
	 * @param affineTransformation La composante affine
	 * @param variationWeight Les poids des différentes variations
	 * @throws IllegalArgumentException Si le tableau des poids des différentes variations ne contient pas 6 éléments
	 */
	...
	/**
	 * Retourne le poids de la variation concernée pour la transformation courante
	 * @param variation La variation dont on veut connaître le poids
	 * @return Le poids de la variation passée en paramètre
	 * @throws IllegalArgumentException Si la variation a un index invalide
	 */
