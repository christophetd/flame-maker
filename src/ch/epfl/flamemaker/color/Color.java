...
public class Color {
	...
	/**
	 * Mélange deux couleurs avec la proportion passée en paramètre de la couleur représentée par le récepteur.
	 ...
	 * @throws IllegalArgumentException quand la proportion n'est pas comprise entre 0 et 1.
	 */
	...
	/**
	 * <p>Calcule la valeur des composantes de la couleur encodées dans un int par groupes de 8 bits.
	 ...
	 * de poids fort à celui de poids faible.</p>
	 * <p>Le format est le suivant avec RR = composante rouge, GG = composante verte, BB = composante bleue<br />
	 * format : 0xFFRRGGBB</p>
	 * 
